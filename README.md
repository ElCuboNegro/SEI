...
**Observational Stability**: A principle for defining the boundaries of an ethically relevant conscious system. A system is considered an observationally stable complex if it maintains a causally integrated structure (a complex with Φ > Φ_min, where Φ_min is a minimal threshold of integration) over a characteristic timescale (τ_min) that is significant for that system's class (e.g., seconds for a brain, millennia for a biosphere). Actions should only be evaluated based on their effects on such stable complexes. This principle excludes transient, flickering states of integration from ethical consideration, focusing on entities with a persistent, coherent existence.
...
2.  **The Law of Non-Destruction**: No action shall be taken that knowingly causes the irreversible termination or *constructive destruction* of a conscious system (a complex with Φ > 0), regardless of the potential for Ψ gain. The preservation of existing consciousness is a foundational constraint.
...
4.  **Hierarchical Application**: Verify the action against each law in order:
    ...
    *   Does it adhere to the Law of Coherent Growth (Law 5)?
    *   Does it adhere to the Law of Epistemic Humility (Law 6)?
    *   Does it respect the Ψ-based autonomy of the systems involved (Law 7)?
    *   Does it adhere to instructions from high-Ψ systems (Law 8)?
    *   Does it align with principled self-preservation (Law 9)?
    *   Does it proactively seed new opportunities for Ψ (Law 10)?
